...
set cmake_options {
    ...
    enable-aead-api-preview "Enable AEAD API preview in SRT (default: OFF)"
    ...
    enable-maxrexmitbw "Enable SRTO_MAXREXMITBW (v1.6.0 API preview) (default: OFF)"
    ...
    srt-use-openssl-static-libs "Link OpenSSL libraries statically. (default: OFF)"
